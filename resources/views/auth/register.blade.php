						...
						<div class="row">
							<div class="col-lg-12">
								...
								<form id="register-form" action="" method="post" role="form" style="display: none;">
									...
									<div class="form-group">
										<textarea type="text" name="alamat" id="alamat" tabindex="1" class="form-control" placeholder="Username" value=""></textarea>
									</div>
									<div class="form-group">
										<input type="text" name="no_hp" id="no_hp" tabindex="1" class="form-control" placeholder="Username" value="">
									</div>
									<div class="form-group">
										<input type="text" name="username" id="username" tabindex="1" class="form-control" placeholder="Username" value="">
									</div>

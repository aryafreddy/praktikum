...
<body>
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
		...
		<div class="row">
			<div class="col-lg-12">
				<h1 class="page-header">Our Testimoni</h1>
			</div>
		</div><!--/.row-->						
...
<table class="table table-dark">
	...
	<tr>
		...
		<td>{{$row->testimoni}}</td>
		<td>
		<form  action="/message/{{$row->id}}" method="POST" style="display:inline-block">
			{{csrf_field()}}
			{{method_field('DELETE')}}
...
<a href="/tambahmessage" class="btn btn-primary btn-lg active" role="button" aria-pressed="true">TAMBAH TESTIMONI</a>

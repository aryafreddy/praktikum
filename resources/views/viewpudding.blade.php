...
<div class="bgded" style="background-image:url('img/img15.jpg');"> 
  ...
  <!-- ################################################################################################ -->
  <div class="wrapper bgded overlay coloured" style="background-image:url('img/img8.jpg');">
  <section class="hoc container clear"> 
    <!-- ################################################################################################ -->
    <h2 class="heading font-x3 underline center btmspace-80">Pudding</h2>
    <ul class="nospace group">
      <li class="one_half first">
        <figure class="group event">
          <div class="one_half first"><a href="#" class="imgoverlay"><img src="img/img22.jpg" alt=""></a></div>
          <figcaption class="one_half">
           <strong class="posh">Chocolate
            <h4 class="heading">IDR 60.000</h4>
            <p>Pudding Chocolate yang dibuat dengan tingkat kemanisan yang tidak berlebihan&hellip;</p>
      ...
      <li class="one_half">
        <figure class="group event">
          <div class="one_half first"><a href="#" class="imgoverlay"><img src="img/img21.jpg" alt=""></a></div>
          <figcaption class="one_half">
            <strong class="posh">Strawberry
            <h4 class="heading">IDR 80.000</h4>
            <p>Pudding Strawberry ini memiliki resep yang cukup simple dengan tambahan krim vanilla diatasnya.&hellip;</p>
            <p><a class="btn small" href="#">View Details &raquo;</a></p>
          </figcaption>
        </figure>
      </li>
      <li class="one_half first">
        <figure class="group event">
          <div class="one_half first"><a href="#" class="imgoverlay"><img src="img/img24.jpg" alt=""></a></div>
          <figcaption class="one_half">
           <strong class="posh">Caramel
            <h4 class="heading">IDR 70.000</h4>
            <p>Pudding Caramel yang dibuat dengan tingkat kemanisan yang tidak berlebihan namun tetap lezat&hellip;</p>
            <p><a class="btn small" href="#">View Details &raquo;</a></p>
          </figcaption>
        </figure>
      </li>
      <li class="one_half">
        <figure class="group event">
          <div class="one_half first"><a href="#" class="imgoverlay"><img src="img/img23.jpg" alt=""></a></div>
          <figcaption class="one_half">
            <strong class="posh">Greentea
            <h4 class="heading">IDR 65.000</h4>
            <p>Pudding Greentea ini memiliki resep yang cukup simple dengan tambahan krim vanilla diatasnya.&hellip;</p>
            <p><a class="btn small" href="#">View Details &raquo;</a></p>
          </figcaption>
        </figure>
      </li>

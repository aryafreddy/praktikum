...
<div class="bgded" style="background-image:url('img/img15.jpg');"> 
  ...
  <section class="hoc container clear"> 
    ...
    <ul class="nospace group">
      <li class="one_half first" id="myTable">
        <figure class="group event">
          ...
          <figcaption class="one_half">
           <strong class="posh">CupCake Chocolate
            <h4 class="heading">IDR 60.000</h4>
            <p>CupCake Chocolate yang dibuat dengan tingkat kemanisan yang tidak berlebihan&hellip;</p>
      ...
      <li class="one_half">
        <figure class="group event">
          <div class="one_half first"><a href="#" class="imgoverlay"><img src="img/17.jpg" alt=""></a></div>
          <figcaption class="one_half">
            <strong class="posh">CupCake Red Velvet
            <h4 class="heading">IDR 80.000</h4>
            <p>CupCake ini memiliki resep yang cukup simple dengan tambahan krim vanilla diatasnya.&hellip;</p>
            <p><a class="btn small" href="#">View Details &raquo;</a></p>
          </figcaption>
        </figure>
      </li>
      <li class="one_half first">
        <figure class="group event">
          <div class="one_half first"><a href="#" class="imgoverlay"><img src="img/img19.jpg" alt=""></a></div>
          <figcaption class="one_half">
           <strong class="posh">CupCake Greentea
            <h4 class="heading">IDR 70.000</h4>
            <p>CupCake Greentea yang dibuat dengan tingkat kemanisan yang tidak berlebihan namun tetap lezat&hellip;</p>
            <p><a class="btn small" href="#">View Details &raquo;</a></p>
          </figcaption>
        </figure>
      </li>
      <li class="one_half">
        <figure class="group event">
          <div class="one_half first"><a href="#" class="imgoverlay"><img src="img/img20.jpg" alt=""></a></div>
          <figcaption class="one_half">
            <strong class="posh">CupCake Oreo
